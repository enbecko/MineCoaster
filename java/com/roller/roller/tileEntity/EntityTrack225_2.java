...
public class EntityTrack225_2 extends Base{
    	...
    	super.updateEntity();
    	{
    		...
    		if(this.first)
    		{
    			...
    			if(this.alignment == 0)
	    		{
	    			...
	    			{
		    			if(this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord-1) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord-1) instanceof EntityTrack225)
		    			{
		    				tmp = (EntityTrack225) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord-1);
		    				if(tmp.alignment == this.alignment)
		    				{
		    					((EntityTrack225)tmp).down = true;
		    					this.makeNext(tmp);
		    				}
		    			}
	    			}
	    		...
	    		if(this.alignment == 1)
	    		{
	    			...
	    			{
		    			if(this.worldObj.getTileEntity(this.xCoord-1, this.yCoord, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord-1, this.yCoord, this.zCoord) instanceof EntityTrack225)
		    			{
	    		...
	    		if(this.alignment == 4)
	    		{
	    			...
	    			{
		    			if(this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord) instanceof EntityTrack225)
		    			{
		    				tmp = (EntityTrack225) this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord);
		    				if(tmp.alignment == this.alignment)
		    				{
		    					((EntityTrack225)tmp).down = true;
		    					this.makeNext(tmp);
