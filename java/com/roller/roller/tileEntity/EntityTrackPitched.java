...
public class EntityTrackPitched extends Base{
    		...
    		if(this.first)
    		{
	    		...
	    		if(this.alignment == 0)
	    		{
	    			if(!down)
	    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord+1) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord+1) instanceof EntityTrackPitchedCurve)
		    			{
		    				tmp = (EntityTrackPitchedCurve) this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord+1);
	    		...
	    		if(this.alignment == 3)
	    		{
	    			if(!down)
	    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord+1, this.yCoord, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord+1, this.yCoord, this.zCoord) instanceof EntityTrackPitchedCurve)
		    			{
		    				tmp = (EntityTrackPitchedCurve) this.worldObj.getTileEntity(this.xCoord+1, this.yCoord, this.zCoord);
