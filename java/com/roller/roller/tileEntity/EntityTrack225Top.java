...
public class EntityTrack225Top extends Base{
    	...
    	super.updateEntity();
    	{
    		...
    		if(this.first)
    		{
    			...
    			if(this.alignment == 2)
	    		{
	    			if(!down)
	    			{
		    			if(this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord+1) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord+1) instanceof EntityTrack225_2Top)
		    			{
	    			...
	    			}else
	    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord-1) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord-1) instanceof EntityTrackBaseTop)
		    			{
	    		...
	    		if(this.alignment == 3)
	    		{
	    			if(!down)
	    			{
	    				if(this.worldObj.getTileEntity(this.xCoord+1, this.yCoord, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord+1, this.yCoord, this.zCoord) instanceof EntityTrack225_2Top)
		    			{
	    			...
	    			{
		    			if(this.worldObj.getTileEntity(this.xCoord-1, this.yCoord-1, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord-1, this.yCoord-1, this.zCoord) instanceof EntityTrack225_2Top)
		    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord-1, this.yCoord-1, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord-1, this.yCoord, this.zCoord) instanceof EntityTrackBaseTop)
		    			{
	    		...
	    		if(this.alignment == 0)
	    		{
	    			...
	    			else
	    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord+1) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord+1) instanceof EntityTrackBase)
		    			{
		    				tmp = (EntityTrackBaseTop) this.worldObj.getTileEntity(this.xCoord, this.yCoord-1, this.zCoord+1);
		    				if((tmp.alignment % 2) == 0)
		    				{
	    		...
	    		if(this.alignment == 1)
	    		{
	    			...
	    			}else
	    			{
		    			...
		    			}else if(this.worldObj.getTileEntity(this.xCoord+1, this.yCoord-1, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord+1, this.yCoord-1, this.zCoord) instanceof EntityTrackBaseTop)
		    			{
		    				tmp = (EntityTrackBaseTop) this.worldObj.getTileEntity(this.xCoord+1, this.yCoord-1, this.zCoord);
		    				if((tmp.alignment % 2) != 0)
		    				{
	    		...
	    		if(this.alignment == 6)
	    		{
	    			if(!down)
	    			{
	    				if(this.worldObj.getTileEntity(this.xCoord, this.yCoord+1, this.zCoord) != null && this.worldObj.getTileEntity(this.xCoord, this.yCoord+1, this.zCoord) instanceof EntityTrack225_2Top)
		    			{
		    				tmp = (EntityTrack225_2Top) this.worldObj.getTileEntity(this.xCoord, this.yCoord+1, this.zCoord);
		    				if(tmp.alignment == this.alignment)
		    				{
		    					((EntityTrack225_2Top)tmp).down = false;
		    					this.makeNext(tmp);
	...
	public float getDisTillOut(EntityTrain train)
	{
		...
		if(this.alignment == 4 && !down)
			return (float) (Math.sqrt(Math.pow(this.yCoord+1-train.posY, 2)+Math.pow(train.posZ-(this.zCoord+0.5F), 2)));
		if(this.alignment == 7 && !down)
			return (float) (Math.sqrt(Math.pow(this.yCoord+1-train.posY, 2)+Math.pow(train.posX-(this.xCoord+0.5F), 2)));
		if(this.alignment == 4 && down)
			return (float) (Math.sqrt(Math.pow(train.posY-this.yCoord, 2)+Math.pow(this.zCoord+1-train.posZ, 2)));
		if(this.alignment == 7 && down)
			return (float) (Math.sqrt(Math.pow(train.posY-this.yCoord, 2)+Math.pow(this.xCoord+1-train.posX, 2)));
