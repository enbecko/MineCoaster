...
import com.roller.roller.models.ModelTrackQuer2;
import com.roller.roller.tileEntity.EntityTrackQuerTop;

public class RenderTrackQuerTop extends RenderError {
  ...
  private static final ResourceLocation field_110807_a = new ResourceLocation("mistery:textures/entities/press.png");
	...
	public RenderTrackQuerTop()
	{
	//	base = new ModelTrackBase();       //the ':' is very important
		curve = new ModelTrackQuer2();       //the ':' is very important
...
//       ResourceLocation Base = (new ResourceLocation("roller:textures/entity/TrackBase.png")); 
       ResourceLocation curve = (new ResourceLocation("roller:textures/entity/TrackQuer2.png")); 
    //   ResourceLocation train = (new ResourceLocation("roller:textures/entity/Train.png")); */
       	//binding the textures

        EntityTrackQuerTop t = (EntityTrackQuerTop)te;
        if(t.color == 1)
