...
import com.roller.roller.models.ModelTrain2;
...
{
    private static final ResourceLocation t = new ResourceLocation("roller:textures/entity/train2.png");
     ...
     */
    public void doRender(EntityMainTrain te, double x, double y, double z, float par8, float par9)
    {
        GL11.glPushMatrix();
	   ...
	   
   {
    ...
    {
        this.doRender((EntityMainTrain)par1Entity, par2, par4, par6, par8, par9);
    }
}
