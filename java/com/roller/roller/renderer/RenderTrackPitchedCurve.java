...
import com.roller.roller.models.ModelPitchedCurve;
import com.roller.roller.tileEntity.EntityTrackPitchedCurve;

public class RenderTrackPitchedCurve extends RenderError {
  ...
  private static final ResourceLocation field_110807_a = new ResourceLocation("mistery:textures/entities/press.png");
	...
	public RenderTrackPitchedCurve()
	{
	//	base = new ModelTrackBase();       //the ':' is very important
		curve = new ModelPitchedCurve();       //the ':' is very important
...
//       ResourceLocation Base = (new ResourceLocation("roller:textures/entity/TrackBase.png")); 
       ResourceLocation curve = (new ResourceLocation("roller:textures/entity/PitchedCurve.png")); 
    //   ResourceLocation train = (new ResourceLocation("roller:textures/entity/Train.png")); */
       	//binding the textures

        EntityTrackPitchedCurve t = (EntityTrackPitchedCurve)te;
        if(t.color == 1)
