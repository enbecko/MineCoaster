...
public class RenderTrack225_2Top extends RenderError {
...
/**       ResourceLocation u45 = (new ResourceLocation("roller:textures/entity/Track45.png")); 
      ...
      Minecraft.getMinecraft().renderEngine.bindTexture(Base);        	
        ...
        EntityTrack225_2Top t = (EntityTrack225_2Top)te;
        if(t.color == 1)
        ...
        if(t.alignment == 0)
        {
            GL11.glTranslatef((float) x + 0.5F, (float) y-0.5F, (float) z + 0.45F);
            GL11.glRotatef(2, 1, 0.0F,0);   
        }
        else if(t.alignment == 1)
        {
            GL11.glTranslatef((float) x + 0.45F, (float) y-0.5F, (float) z + 0.5F);
            GL11.glRotatef(-2, 0.0F, 0.0F, 1F);                       
        	GL11.glRotatef(90F, 0.0F, 1, 0);
               
        }
        else if(t.alignment == 2)
        {
            GL11.glTranslatef((float) x + 0.5F, (float) y-0.5F, (float) z + 0.55F);
            GL11.glRotatef(-2, 1, 0.0F,0);   
        ...
        {
            GL11.glTranslatef((float) x + 0.55F, (float) y-0.5F, (float) z + 0.5F);
            GL11.glRotatef(2, 0.0F, 0.0F, 1F);                       
