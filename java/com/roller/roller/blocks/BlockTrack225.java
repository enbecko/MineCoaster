...
public class BlockTrack225 extends BaseBlock{

	public BlockTrack225(Material p_i45386_1_) {
		super(p_i45386_1_);
	}
    ...
    public void onBlockPlacedBy(World w, int x, int y, int z, EntityLivingBase p, ItemStack p_149689_6_) 
    {
    	if(w.getBlock(x, y, z+1) == Blocks.air)
    		w.setBlock(x, y, z+1, Main.track225_2, 2, 0);
    	else
    	{
    		if(w.getBlock(x+1, y, z) == Blocks.air)
    		{
        		w.setBlock(x+1, y, z, Main.track225_2, 2, 0);
    		...
    		{
        		w.setBlock(x, y+1, z, Main.track225_2, 2, 0);
    	    	Base te = (Base) w.getTileEntity(x, y, z);
